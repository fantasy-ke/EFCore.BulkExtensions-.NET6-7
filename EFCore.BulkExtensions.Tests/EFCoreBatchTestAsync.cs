...
//        var firstItem = (await context.Item.ToListAsync()).First();
//        var lastItem = (await context.Item.ToListAsync()).Last();
...
//    {
//        using var context = new TestContext(ContextUtil.GetOptions());
//        await context.Item.AddAsync(new Item { }); // used for initial add so that after RESEED it starts from 1, not 0
//        await context.SaveChangesAsync();

//        await context.Item.BatchDeleteAsync();
//        await context.BulkDeleteAsync(context.Item.ToList());
...
//        {
//            query = context.Item.Where(a => a.ItemId <= 500 && a.Price == null);
...
//    {
//        using var context = new TestContext(ContextUtil.GetOptions());
//        return await context.Item.Where(a => a.ItemId > 500).Take(1).BatchDeleteAsync();
//    }

//    private static async Task RunBatchDeleteAsync()
//    {
//        using var context = new TestContext(ContextUtil.GetOptions());
//        await context.Item.Where(a => a.ItemId > 500).BatchDeleteAsync();
//    }
